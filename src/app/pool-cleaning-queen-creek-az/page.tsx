    ...
    return (
        <main className='bg-white overflow-x-hidden'>
            ...
            <section className="relative flex h-screen items-center justify-center">
                ...
                <div className="relative z-10 text-center text-white md:mx-20 mx-2 md:mt-0 -mt-16">
                    <div className='flex flex-col items-center jutify-center w-full mb-6 -mt-4'>
                        <div className='bg-sky-100/50 max-w-fit h-fit px-4 sm:py-2 py-1 rounded-full'>
                            <h1 className="sm:text-sm text-xs font-bold ">
                                Best Pool Cleaning Service in Queen Creek
                            </h1>
                        </div>
                    ...
                    <p className="mb-12 text-xl md:text-2xl w-full">
                        Expert Pool Cleaning and Maintenance in Queen Creek, AZ. We
            ...
            <section className="bg-background mt-20">
                <TestimonialsMarqueeGrid location='Queen Creek' />
            </section>
            ...
            <section className="mt-24 bg-background px-8">
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="mb-8 text-xl text-neutral-600">
                        Experience top-rated pool cleaning and maintenance services in Queen Creek, AZ. Whether it&apos;s for small residential pools, play pools, or commercial properties, Krystal Clean Pool Service ensures your pool stays pristine all year.
                    </p>
                </div>

                <FeaturesGrid location='Queen Creek' />
            </section>
            ...
            {/* Featured Posts */}
            <PricingGrid location='Queen Creek' />

            {/* Featured Posts */}
            <BlogPostList location="Queen Creek" />
