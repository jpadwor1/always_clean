...
const Page = () => {
  return (
    ...
    >
        ...
        <div className='max-w-3xl mx-auto'>
          ...
          >
            <div className='w-full md:w-3/4 lg:w-auto lg:pr-10'>
              ...
              <p className='text-coolGray-500 font-medium'>
              Find out about our policy on sharing data with external entities and under what circumstances this might occur.
              </p>
            </div>
            <div className='ml-auto'>
              <svg
          ...
          >
            <div className='w-full md:w-3/4 lg:w-auto lg:pr-10'>
              ...
              <p className='text-coolGray-500 font-medium'>
              Discover the security measures we employ to protect your personal information from unauthorized access or breaches.
              </p>
            </div>
            <div className='ml-auto'>
              <svg
          ...
          >
            <div className='w-full md:w-3/4 lg:w-auto lg:pr-10'>
              ...
              <p className='text-coolGray-500 font-medium'>
              Understand your rights about accessing, modifying, or requesting the deletion of your personal data.
              </p>
            </div>
            <div className='ml-auto'>
              <svg
      ...
      <p>
        This privacy notice for Krystal Clean Pool Service LLC. (&quot;we,&quot; &quot;us,&quot; or
      ...
      <ul>
        <li>
          ...
          <Link href="https://genuine-hamster-b2f8ae.netlify.app/">
            https://genuine-hamster-b2f8ae.netlify.app/
          </Link>
      ...
      <p>
        ...
        <Link href="mailto:john@krystalclean.com">john@krystalclean.com</Link>.
      </p>
      <h3 className='text-2xl font-semibold my-4 self-center'>SUMMARY OF KEY POINTS</h3>
      <p>
      ...
      <h3 id='informationWeCollect' className='text-2xl font-semibold pt-20 self-center '>1. WHAT INFORMATION DO WE COLLECT?</h3>
      ...
      <p>
        ...
        is stored by Stripe Inc.. You may find their privacy notice link(s) here:{" "}
      ...
      <h3 id='processData' className='text-2xl font-semibold pt-20 my-4 self-center'>2. HOW DO WE PROCESS YOUR INFORMATION?</h3>
      <p>
      ...
      <h3 id='dataSharing' className='text-2xl font-semibold my-4 pt-20 self-center'>3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h3>
      <p>
      ...
      <ul>
        ...
        <li className='list-disc'>
          ...
          Analytics to track and analyze the use of the Services. The Google
          Analytics Advertising Features that we may use include: Remarketing
          with Google Analytics. To opt out of being tracked by Google Analytics
          ...
          <Link href="http://optout.networkadvertising.org/">http://optout.networkadvertising.org/</Link>{" "}
          and{" "}
      ...
      <h3 className='text-2xl font-semibold my-4 self-center'>4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h3>
      ...
      <h3 className='text-2xl font-semibold my-4 self-center'>5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3>
      <p>
      ...
      <h3 className='text-2xl font-semibold my-4 self-center pt-20'>6. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
      <p>
      ...
      <h3 id='dataSecurity' className='text-2xl font-semibold my-4 self-center pt-20'>7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
      <p>
      ...
      <h3 className='text-2xl font-semibold my-4 self-center pt-20'>8. DO WE COLLECT INFORMATION FROM MINORS?</h3>
      <p>
      ...
      <h3 id='dataRights' className='text-2xl font-semibold my-4 self-center pt-20'>9. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
      <p>
      ...
      <h3 className='text-2xl font-semibold my-4 self-center pt-20'>10. CONTROLS FOR DO-NOT-TRACK FEATURES</h3>
      <p>
      ...
      <h3 className='text-2xl font-semibold my-4 self-center pt-20'>11. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
      <p>
      ...
      <h3 className='text-2xl font-semibold my-4 self-center pt-20'>12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h3>
      <p>
        If you have questions or comments about this notice, you may email us at{" "}
        <Link href="mailto:john@krystalclean.com">john@krystalclean.com</Link> or
