                    ...
                    <div className='flex flex-wrap xl:items-center -mx-4'>
                        <div className='w-full md:w-1/2 px-4 mb-16 md:mb-0'>
                            ...
                            <p className='mb-8 text-lg md:text-xl text-slate-600'>
                                Expert Pool Cleaning servicing San Tan Valley and surrounding areas for a Sparkling, Hassle-Free Summer. We
                ...
                <div className='container px-4 mx-auto'>
                    <div className='md:max-w-4xl mb-12 mx-auto text-center'>
                        <span className='inline-block py-px px-2 mb-4 text-xs leading-5 text-blue-500 bg-blue-100 font-medium uppercase rounded-full shadow-sm'>
                            SANT TAN VALLEY POOL CLEANING
                        </span>
                        <h1 className='mb-4 text-3xl md:text-4xl leading-tight font-bold tracking-tighter'>
                            Reliable Pool Cleaning Services in San Tan Valley, AZ
                        </h1>
                    ...
                    <div className='flex flex-wrap -mx-4'>
                        <div className='w-full md:w-1/2 lg:w-1/3 px-4'>
                            <div className='h-full p-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                                ...
                                <h2 className='mb-2 text-md leading-tight font-medium text-blue-600'>
                                    Crystal Clear Pools in San Tan Valley, AZ
                                </h2>
                                <p className='text-gray-500 font-medium'>
                                    Our surface cleaning removes leaves, debris, and floating impurities, giving your San Tan Valley pool a spotless and inviting look every time.
                                </p>
                            </div>
                        </div>
                        <div className='w-full md:w-1/2 lg:w-1/3 px-4'>
                            <div className='h-full p-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                                ...
                                <h2 className='mb-2 text-md leading-tight font-medium text-blue-600'>
                                    Comprehensive Pool Care in San Tan Valley
                                </h2>
                                <p className='text-gray-500 font-medium'>
                        ...
                        <div className='w-full md:w-1/2 lg:w-1/3 px-4'>
                            <div className='h-full p-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                                ...
                                <h2 className='mb-2 text-md leading-tight font-medium text-blue-600'>
                                    Keep San Tan Valley Pools Running Smoothly
                                </h2>
                                <p className='text-gray-500 font-medium'>
                        ...
                        <div className='w-full md:w-1/2 lg:w-1/3 px-4'>
                            <div className='h-full p-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                                ...
                                <h2 className='mb-2 text-md leading-tight font-medium text-blue-600'>
                                    Safe, Balanced Water for San Tan Valley Families
                                </h2>
                                <p className='text-gray-500 font-medium'>
                        ...
                        <div className='w-full md:w-1/2 lg:w-1/3 px-4'>
                            <div className='h-full p-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                                ...
                                <h2 className='mb-2 text-md leading-tight font-medium text-blue-600'>
                                    Reliable Pool Equipment in San Tan Valley
                                </h2>
                                <p className='text-gray-500 font-medium'>
                        ...
                        <div className='w-full md:w-1/2 lg:w-1/3 px-4'>
                            <div className='h-full p-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                                ...
                                <h2 className='mb-2 text-md leading-tight font-medium text-blue-600'>
                                    Seasonal Pool Care for San Tan Valley, AZ
                                </h2>
                                <p className='text-gray-500 font-medium'>
